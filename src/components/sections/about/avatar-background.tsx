...
export function AvatarBackground({}: AvatarBackgroundProps) {
  return (
    <div className="absolute inset-0 pointer-events-none">
      {/* Glowing Orb Top Right */}
      <div className="absolute -top-10 -right-10 w-32 h-32 bg-purple-500/30 rounded-full blur-3xl animate-pulse" />
      {/* Glowing Orb Bottom Left */}
      <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-violet-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
