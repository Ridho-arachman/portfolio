...
export const EXPERIENCES: Experience[] = [
  {
    ...
    description: [
      ...
      "Mengimplementasikan unit testing menggunakan Jest dan React Testing Library.",
    ],
  },
  {
    id: 2,
    ...
    description: [
      ...
      "Mengelola infrastruktur server (VPS) dan database PostgreSQL untuk event organisasi.",
    ],
  },
  {
    id: 3,
    ...
    description: [
      ...
      "Mengimplementasikan SEO best practices yang meningkatkan traffic organik klien hingga 40%.",
